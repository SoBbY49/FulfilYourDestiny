...
def part_2a():
    s = """
You walk the opposite way from the other prisoners trying to look for a way out.
You continue walking down the corridor until you see a room with five guards inside.
The door is open and you peak inside, the five guards are talking and there is a large door behind them.
...
They don't see you at first and you manage to kill the two that were closest to you.
The three other guards now see you and charge at you with their swords.
You lunge at one of them and stab him in the neck but the other two guards come from either side of you.
...
def part_2ab():
    ...
    if diceresult <11:
        s = """
You begin firing arrows at the guards but you can't fire fast enough as they begin running at you.
You try to pull out your dagger in time but one of the guards slices down and cuts your arm off.
%s""" % (fyd_art.you_died())
...
As son as they do you fire, the arrow pierces through the first guards neck and gets stuck in the second guard.
They both fall to the ground and the three guards begin running towards you.
You quickly fire one more arrow and you kill one more, you then pull out your dagger.
You run at the two guards and stab one in the chest, the other guard swings at you.
...
He starts walking the opposite way of the prisoners and you realise that that's the way out.
You continue walking down the corridor until you see a room with five guards inside.
The door is open and you peak inside, the five guards are talking and there is a large door behind them.
...
The other ground jumps up and is about to shout out for help but you manage to shoot him in the chest.
He falls over to the ground and the man walks over to you.
He looks at you and nods and starts walking behind you, you decide to follow him.
He starts walking the opposite way of the prisoners and you realise that that's the way out.
You continue walking down the corridor until you see a room with five guards inside.
The door is open and you peak inside, the five guards are talking and there is a large door behind them.
...
The man is able to stab one in the neck and is about to kill another one.
The guard swings his sword and cuts the man's throat, you shoot an arrow and kill that guard.
...
You pull out your dagger and stab both guards as they fall to the ground.
The man gets up and stares at you, he doesn't seem very thankful.
He starts walking behind you, you decide to follow him.
He's walking the opposite way of the prisoners and you realise that that's the way out.
You continue walking down the corridor until you see a room with five guards inside.
The door is open and you peak inside, the five guards are talking and there is a large door behind them.
...
def part_1bbb():
    s = """
The guards are still waiting for you to join in but you quickly pull out your dagger.
You stab them both in the neck and they fall to the ground, the man gets up of the floor.
He looks at you and nods and starts walking behind you, you decide to follow him.
He starts walking the opposite way of the prisoners and you realise that that's the way out.
You continue walking down the corridor until you see a room with five guards inside.
The door is open and you peak inside, the five guards are talking and there is a large door behind them.
...
The guards laugh at the man and one punches him to the floor as he falls out of your grip.
...
You manage to trick a few guards into looking the other way while you slice the other guards throats.
You have done this to three guards until the other two guards see their dead bodies.
...
Instead of taking you the way the other prisoners went he takes you the opposite way.
You begin to hear some talking so you think that now is the time to kill him.
With your wrists still in handcuffs you dislocate both your thumbs and slip your hands through the handcuffs.
You drop your handcuffs and the guard walking you looks down at them, you pull your dagger out and slice his throat.
...
def part_2d():
    s = """
You walk the opposite way from the other prisoners trying to look for a way out.
You continue walking down the corridor until see a room with five guards inside.
The door is open and you peak inside, the five guards are talking and there is a large door behind them.
'That must be the way out' you think.
...
def part_2da():
    s = """
You sneakily enter the room and you manage to slice two of the guards throats without making a sound.
...
They simultaneously swing at you, as you're unable to dodge out of the way you get chopped up.
    %s""" % (fyd_art.you_died())
    answers = {}
    return s, fyd_art.archer(), answers
