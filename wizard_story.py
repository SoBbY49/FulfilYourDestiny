...
You try to feel around but all you can feel is the cold ground and
 hear some water dripping.
As your eyes start to adjust to the darkness you look around once
 more and come face to face with a skeleton.
You jump back and see that it is wearing shackles, ‘How did I get
 here?’.
You get up and as you try to find a way out you accidentally stub
...
def part_1a():
    s = """
You hide behind a bookshelf that is right next to the staircase and
 hold the staff above your head.
Two peasants walk down the stairs behind a very large shrouded man
 with a large axe in both hands.
You hear one of the peasants whisper to the other peasant,
 `Oh no, the wizard has escaped.’.
You sneak up behind them and whack one of the peasants over the head.
He falls to the ground and the other peasant sees you and points at
 you with a shaky hand.
It seems like he is trying to talk but no words are coming out of his
 mouth.
You hit him across the head with your staff and he falls over.
As you look towards the large man with the large axe you see that he
...
The amount of force you put into the swing shatters the staff, the
 wood explodes.
The large gem that was on top of the staff falls the the ground.
The man doesn't even flinch or look affected by the blow.
The man picks the gem up and crushes it in his hand, he opens his
 hand and pours the gem that is now sand onto the ground.
...
def part_1ab():
    s = """
You say fireball and once again a ball of fire emerges from the gem
 on your staff.
You thrust it into the man's chest and an explosion erupts.
You're blown backwards onto the stairs and the man gets launched
 into the wall.
...
def part_2b():
    s = """
As you reach the top of the stairs you see a large open door that
 leads to outside.
You begin running to it but you suddenly hear rumbling.
You turn around and you see the large man walking up the stairs
 using the large axe to help stabilise himself after the huge blast.
...
The fireball flies at the large man but he is able to move out of
 the way in time for the ball of fire to explode against the wall.
...
def part_2bb():
    s = """
You cast invisibility and you vanish, the man now enraged starts
 swinging his axe everywhere trying to find you.
He begins destroying everything in the room and you quickly run
...
The large gem that was on top of the staff falls the the ground.
The man doesn't even flinch or look affected by the blow.
The man picks the gem up and crushes it in his hand, he opens his hand
 and pours the gem that is now sand onto the ground.
    %s""" % (fyd_art.you_died())
...
The man suddenly swings his giant axe at where you were but you manage
...
You peek from behind the bookshelf and see two peasants behind a
 very large shrouded man with a large axe in his hands.
You jump into view and thrust your magic staff towards them, the 
...
def part_1ba():
    ...
    if diceresult <11:
        s = """
You try to jump out of the way but you trip over your leg and fall
 to the ground.
The man runs at you and slices his axe down onto you.
        ...
        s = """
You manage to jump out of the man's way in time and he slices the
 bookshelves that were near you in half.
He wasn't able to slow down in time and runs through the
 bookshelves into the wall.
The room shakes and parts of rock start to fall down from the
 ceiling.
You run towards the stairs hoping to get out of the room before
 the room collapses.
The man locks onto you and charges you once again.
You manage to get up the stairs before he runs into the staircase
 turning the stairs to rubble.
You see the huge rocks fall from the staircase onto the man and
 it goes quiet.
...
def part_1bb():
    s = """
You say disappear and you become invisible.
The man keeps charging to where you were and smashes into the
 bookshelves.
The man starts destroying everything in the room trying to find you.
You creep up the stairs out of the room.
...
def part_1c():
    s = """
Not needing to hide, you stand out in the open and see two peasants
 and a very large shrouded man holding a huge axe come down the stairs.
They walk right past you towards the small dungeon cell you
 were locked in.
The large man looks at the exploded door and sees that you’re
 not inside the cell.
The peasants start getting worried and start shaking, the
 large man mutters to the peasants ‘Find the wizard’.
The peasants nod their heads worryingly and hurry up the stairs.
The large man sits down on a chair in the room and starts to
 sharpen his large axe.
You just remembered that there was nothing in the spell book
...
def part_1ca():
    s = """
You keep standing there and observing the man as he keeps sharpening
 his axe.
...
The man gets of his chair and throws the huge axe at you, slicing
 you down the middle.
...
def part_1cb():
    s = """
The man keeps sharpening his axe on the chair and you creep towards
 the stairs and make your way up.
As soon as you get out of view of the room you begin to see your
 hands again.
